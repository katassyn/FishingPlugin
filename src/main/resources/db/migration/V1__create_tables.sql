...
CREATE TABLE IF NOT EXISTS fishing_item_def (
...
CREATE TABLE IF NOT EXISTS fishing_mirror_item (
    `key` VARCHAR(64) PRIMARY KEY,
    category VARCHAR(32) NOT NULL,
    broadcast BOOLEAN NOT NULL,
    item_base64 TEXT
...
CREATE TABLE IF NOT EXISTS fishing_quest (
...
CREATE TABLE IF NOT EXISTS fishing_param (
    `key` VARCHAR(64) PRIMARY KEY,
